...
<body>
	...
	<div class="header">
		<h1 class="headerLogo">
			<a title="图书管理系统" target="_blank" href="http://www.freemoban.com/"><img
	...
	<div class="banner">
		...
		<div class="login-aside">
			...
			<div id="o-box-down" style="table-layout: fixed;">
				...
				<form action="RegistServlets" method="post">
					<div class="fm-item">
						<label for="logonId" class="form-label">请输入账号：</label> <input
							type="text" value="" maxlength="100" name="username"
							class="i-text" datatype="s6-18">
						<div class="ui-form-explain"></div>
					</div>
					<div class="fm-item">
						<label for="logonId" class="form-label">请输入密码：</label> <input
							type="password" value="" maxlength="100" name="password"
							class="i-text" datatype="*6-16" nullmsg="请设置密码！">
						<div class="ui-form-explain"></div>
					</div>
					<div class="fm-item">
						<label for="logonId" class="form-label">请确认密码：</label> <input
							type="password" value="" maxlength="100" name="rpsw"
							class="i-text" datatype="*6-16" nullmsg="请设置密码！">
						<div class="ui-form-explain"></div>
					</div>
					...
					<div class="fm-item">
						<label for="logonId" class="form-label"></label> <input
							type="submit" value="" tabindex="4" id="注册"
							class="btn-login">
						<div class="ui-form-explain"></div>
					</div>
